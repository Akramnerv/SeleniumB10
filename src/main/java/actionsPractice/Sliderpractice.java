...
public class Sliderpractice {
    ...
    public void sliderTest () {
        ...
        navigateToTarget(slider, text, driver, 1.5);
       ...
       // actions.clickAndHold(slider).moveByOffset(50, 0).build().perform();
        ...
        // source --> target -- find the webelement of the target using Point class (getLocation() method),
        //you can provide the x and y coordinates
